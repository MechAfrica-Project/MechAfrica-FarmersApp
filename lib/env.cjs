...
const API_URL_PLACEHOLDER = 'https://mechafrica-backend.onrender.com';
...
function resolveApiUrlRaw() {
  return process.env.API_URL || process.env.EXPO_PUBLIC_API_BASE_URL || process.env.EXPO_PUBLIC_API_URL || null;
}
